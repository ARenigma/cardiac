...
const conditions = {
  "heart-failure": {
    ...
    treatments: [
      ...
      "Implantable cardioverter-defibrillator (ICD) evaluation and management",
      "Advanced cardiomyopathy evaluation — ischemic vs non-ischemic",
    ],
  },
  arrhythmia: {
    title: "Arrhythmia",
    ...
    treatments: [
      ...
      "Cardioversion (electrical restoration of normal rhythm)",
      "Transesophageal echocardiogram (TEE) — pre-procedure imaging",
      "Loop recorder placement — long-term rhythm monitoring",
      "Watchman device — stroke prevention in AFib without long-term anticoagulation",
    ],
  },
  "coronary-artery": {
    ...
    treatments: [
      ...
      "Complex PCI — CTO intervention, rotational atherectomy, intracoronary lithotripsy",
      "Mechanical circulatory support — Impella-assisted high-risk PCI",
      "Left main and bifurcation intervention",
      "Transradial catheter approach (wrist-based, reduced recovery)",
  ...
  "structural-heart": {
    ...
    treatments: [
      "TAVR (Transcatheter Aortic Valve Replacement) — aortic stenosis without open surgery",
      "MitraClip / TEER — minimally invasive mitral valve repair",
      "PFO & ASD closure — cryptogenic stroke evaluation",
      "Left Atrial Appendage Occlusion (LAAO / Watchman) — stroke prevention in AFib",
      "Open Heart Surgery (CABG / valve surgery, when indicated) — surgical referral and co-management",
      "TEE (Transesophageal Echocardiogram) — structural imaging",
    ],
  },
  "peripheral-artery": {
    ...
    symptoms: [
      ...
      "Change in colour of legs (pale, bluish, or dark red)",
      "Hair loss or slow hair growth on legs and feet",
    ],
    treatments: [
      "Peripheral angiography — diagnostic imaging of leg arteries",
      "Angioplasty and stenting — restoring blood flow to the lower extremities",
      "Atherectomy — removing plaque from peripheral arteries",
      "Chronic limb-threatening ischemia (CLTI) management",
      "Venous disease and deep vein thrombosis (DVT) management",
      "Carotid artery disease evaluation and treatment",
    ],
  },
